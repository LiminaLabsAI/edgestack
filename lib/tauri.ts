...
const defaultNotifications = [
  ...
  },
  {
    ...
    body: "PreceptaAI saved $248.50 in cloud alternative fees this week by running 324 local LLM workflows.",
...
### Regulatory Rationale:
* **SOC2 CC6.1 & CC6.3 (Audit Trail & Logging):** You must maintain a log of security-relevant events. PreceptaAI writes every policy check to a local SQLite audit table, creating a tamper-proof record of what was allowed or blocked.
...
When this rule is enabled, all browsing operations are checked, and anything exceeding the rate will trigger an audit warning.`,
        ...
        return {
          text: `Hello! I would be happy to advise you on your PreceptaAI policies. 
...
\`\`\`yaml
# Generated by PreceptaAI Builder Copilot
...
You can review this pipeline and click **"Apply YAML to Editor"** above to load these steps directly into your Monaco canvas!`,
    ...
    case "generate": {
      ...
      return {
        text: "I am PreceptaAI's local AI engine. I processed your request completely offline. The outputs are generated and verified on your CPU/GPU cores safely."
      };
    }
    ...
    case "export_policies_yaml": {
      ...
      return `# PreceptaAI Governance Policies\n# Exported: ${new Date().toISOString()}\n\n${yaml}`;
    }
